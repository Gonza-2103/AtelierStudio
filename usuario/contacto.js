document.addEventListener("DOMContentLoaded", function () {
    ...
    // Asignación de color rojo a los mensajes de error
    if (errorNombre) errorNombre.style.color = "red";
    if (errorCorreo) errorCorreo.style.color = "red";
    if (errorComentario) errorComentario.style.color = "red";
    ...
    formulario.addEventListener("submit", function (event) {
        ...
        if (formularioValido) {
            ...
            // Limpiar mensajes residuales en caso de haber quedado texto previo
            errorNombre.innerHTML = "";
            errorCorreo.innerHTML = "";
            errorComentario.innerHTML = "";

        } else {
            let camposConError = [];  // Guardar los nombres de los campos con errores
